...
#	    NSX Edge during failback from Bansar to Bangi
#	    
#	     
...
Write-Host "Disabling Core-Uplink-DR connect to VLAN 215"
Write-Host "Enabling Core-Uplink connect to VLAN 216"
...
#Disconnect Core-Uplink-DR from VLAN 215
$coreUplinkDr.isConnected = "false"

#Connect Core-Uplink to VLAN 216
...
$coreUplinkIpAddr = $coreUplink.addressGroups.addressGroup.primaryAddress
$edgerouting.routingGlobalConfig.routerId = $coreUplinkIpAddr

#Change Transit-internal interface OSPF Area to 216. Verify the vnic #
$transitIntOspfArea = $edgerouting.ospf.ospfinterfaces.ospfinterface | where-object {$_.vnic -eq "1"} 
$transitIntOspfArea.areaId = "216"
...
#Change DLR interface OSPF Area to 216
